...
export async function POST(req: NextRequest) {
    const connection = new Connection("https://mainnet.helius-rpc.com/?api-key=560038cf-6c76-4dbb-8c1f-8da5b53c2523")
    const data: {
        quoteResponse: any
    } = await req.json();
    ...
    const { swapTransaction } = await (
      ...
      // Convert the stored private key into a Keypair
