...
export function Swap({ tokenBalances }: {
    ...
    // base Asset is basically the asset which your trying to sell
    // base token is always the native token, in this case it is solana
    const [baseAsset, setBaseAsset] = useState(SUPPORTED_TOKENS[0])
    // qute Assset is what you want to sell with
